...
public class GameController {
    ...
    public List<Game> recuperarGamesPorSlugCategory(@PathVariable("slugCategory") String slugCategory) {
    ...
    public ResultadoPaginado<Game> recuperarGamesComPaginacao(
        ...
        ResultadoPaginado<Game> resultadoPaginado = new ResultadoPaginado<>(
